...
python bitwise_mnist.py -exp mnist_signswiss -ib tanh -wb sign_swiss -e 200 -b 128 -lr 1e-2 -do 0.2 -bnm 0.01 -lrd 0.1 -dp 150
...
python bitwise_mnist.py -exp mnist_ptanh -ib tanh -wb ptanh -e 200  -b 128 -lr 1e-2 -do 0.2 -bnm 0.01 -lrd 0.1 -dp 150
python bitwise_mnist.py -exp bmnist_signswiss -ib clipped_ste -wb ptanh_ste -lf mnist_ptanh.model -cw -e 200 -b 128 -bnm 0.2 -lrd 0.1 -dp 100 -lr 1e-3
