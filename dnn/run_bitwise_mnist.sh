python bitwise_mnist.py -exp tanh_mnist -ib tanh -wb identity -e 250 -b 128 -lr 1e-2 -do 0.5 -bnm 0.01 -lrd 0.1 -dp 200
python bitwise_mnist.py -exp cw_cg_mnist -ib clipped_ste -wb clipped_ste -lf tanh_mnist.model -cw -e 200 -b 128 -bnm 0.2 -lrd 0.1 -dp 100 -lr 1e-3
